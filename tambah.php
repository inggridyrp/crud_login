        ...
        <div class="row"><p></p>
            ...
            <div class="col-12">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="penulis" class="form-label">Hobi</label><br>
                        <input type="checkbox" name="hobi[]" value="berenang" /> Berenang<br>
                        <input type="checkbox" name="hobi[]" value="karaoke" /> Karaoke<br>
                        <input type="checkbox" name="hobi[]" value="kuliner" /> Kuliner<br>
                        <input type="checkbox" name="hobi[]" value="tamasya" /> Tamasya<br>
