...
<body>
    <div class="container">
        <div class="pt-5 d-flex justify-content-between">
            <div class="col">
            <h1>Selamat Datang <font color="magenta"><?php echo $_SESSION['hak_akses'];?></font> di Toko Buku ABC</h1>
                <p>Ini adalah halaman laporan penjualan buku</p>
            </div>
        </div>
       
        <div class="row">
            <div class="col-12">
                <h2>Data Penjualan Buku</h2>
            </div>
    ...
    <a class="btn btn-danger" href="logout.php">Logout</a><p></p>
